...
# Lista de produtos sem tags de imagem para evitar bloqueios do seu navegador
PRODUTOS = [
    {
        "id": 1,
        "nome": "⌚ Relógio Smartwatch",
        "preco": "R$ 149,90",
        "descricao": "Notificações, batimentos cardíacos e design moderno de última geração."
    },
    {
        "id": 2,
        "nome": "🎧 Fone Bluetooth",
        "preco": "R$ 89,90",
        "descricao": "Alta qualidade de som estéreo e bateria de longa duração para o dia todo."
    }
]

# Modelo visual limpo e otimizado
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <style>
        ...
        .card { background: white; border-radius: 12px; box-shadow: 0 6px 12px rgba(0,0,0,0.15); width: 300px; padding: 25px; text-align: left; transition: 0.3s; border-top: 5px solid #1a1a1a; }
        .card:hover { transform: translateY(-5px); }
        .card h3 { margin: 0 0 10px 0; color: #222; font-size: 22px; }
        .card p { color: #666; font-size: 15px; min-height: 50px; margin-bottom: 20px; line-height: 1.4; }
        .price { color: #25D366; font-size: 26px; font-weight: bold; margin: 15px 0; }
        .btn-buy { display: block; background: #25D366; color: white; text-align: center; padding: 14px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px; }
